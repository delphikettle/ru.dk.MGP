...
//		// TODO: Implement this method
	...
	public void Init()
	{
		...
		new Particle((rnd.nextFloat()*1920*1-0*1920)/this.getScale(),(rnd.nextFloat()*1024*1-0*1024)/this.getScale(),(float)Math.random()*100-50,(float)Math.random()*100-50,((1024*16)),2*((float)( rnd.nextDouble()*8-4)));
		for(int i=0;i<300;i++)
