...
//		// TODO: Implement this method
	...
	public void Init()
	{
		...
		new Particle(rnd.nextFloat()*(getXMax()-getXMin()-200*2*4)+getXMin()+100*2*4,rnd.nextFloat()*(getYMax()-getYMin()-200*2*4)+getYMin()+100*4*2,(float)Math.random()*100-50,(float)Math.random()*100-50,((1024*8*4)),2*((float)(4*( rnd.nextDouble()*8-4))));
		for(int i=0;i<7;i++)
